...
# plt.ylabel('Coefficient de traînée de l\'aile')
# plt.title('Coefficient de traînée de l\'aile en fonction de l\'angle d\'attaque')
# plt.legend()
# plt.grid()
# plt.show()

# plt.plot(AoA, CL, label='Cl wing')
# plt.xlabel('Angle d\'attaque (°)')
# plt.ylabel('Coefficient de portance de l\'aile')
# plt.title('Coefficient de portance de l\'aile en fonction de l\'angle d\'attaque')
# plt.legend()
# plt.grid()
# plt.show()

plt.plot(cd_polar, cl_polar, label='Polar de l\'aile')
plt.scatter(CD_wing, CL, color='red', label='Données expérimentales')
plt.xlabel('Coefficient de traînée de l\'aile')
plt.ylabel('Coefficient de portance de l\'aile')
plt.title('Polar de l\'aile')
plt.legend()
plt.grid()
plt.show()

plt.plot(AoA, e, label='Oswald efficiency factor')
plt.xlabel('Angle d\'attaque (°)')
plt.ylabel('Oswald efficiency factor')
plt.title('Oswald efficiency factor en fonction de l\'angle d\'attaque')
plt.legend()
plt.grid()
plt.show()
